			...
			<div id="content" class="clearfix row-fluid">
				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<?php } elseif (is_author()) { ?>
						<h1 class="archive_title h2">
							<span><?php _e("", "bonestheme"); ?></span> <?php get_the_author_meta('display_name'); ?>
						</h1>
					<?php } elseif (is_day()) { ?>
						<h1 class="archive_title h2">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>" class="article-banner">
								...
								<div class="author" role="author" title="<?php the_author_meta( 'display_name' ); ?>"><?=get_avatar( get_the_author_meta('user_email'), 40 );?></div>
							</a>
